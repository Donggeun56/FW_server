    let weather = {
        ...
        .then((data) => {
            ...
            weadet = [[data.list[7].weather[0].description, data.list[7].main.temp-273.15],
            [data.list[9].weather[0].description, data.list[9].main.temp-273.15],
            [data.list[12].weather[0].description, data.list[12].main.temp-273.15]];
            Cloth_change();
        });
